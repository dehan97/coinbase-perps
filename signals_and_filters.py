...
##############################################################################
#                       1) LOAD DATA BY TIMEFRAME (CACHED)                   #
##############################################################################
...
class SignalCreator:
    """
    Contains static methods for creating signals.
...
#     df_final_signals = generate_signals(
#         timeframe=timeframe,
...
#     print(df_final_signals.head())  # Display the head of the filtered DataFrame
